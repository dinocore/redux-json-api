...
var readEndpoint = exports.readEndpoint = function readEndpoint(endpoint) {
  var _ref4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      _ref4$clearTypes = _ref4.clearTypes,
      clearTypes = _ref4$clearTypes === undefined ? [] : _ref4$clearTypes;
  ...
  return function (dispatch, getState) {
    ...
    return new _promise2.default(function (resolve, reject) {
      (0, _utils.apiRequest)('' + apiEndpoint, {
        ...
        dispatch(apiRead((0, _extends3.default)({ endpoint: endpoint, clearTypes: clearTypes }, json)));
        onSuccess(json);
        resolve(json);
      }).catch(function (error) {
        var err = error;
...
var updateResource = exports.updateResource = function updateResource(resource) {
  ...
  return function (dispatch, getState) {
    ...
    var id = resource.id ? '/' + resource.id : "";
    var endpoint = '' + apiHost + apiPath + '/' + resource.type + id;
...
var reducer = exports.reducer = (0, _reduxActions.handleActions)((_handleActions = {}, (0, _defineProperty3.default)(_handleActions, _constants.API_SET_HEADERS, function (state, _ref8) {
  ...
  var newState = (0, _stateMutation.updateOrInsertResourcesIntoState)(state, resources, payload.clearTypes);
